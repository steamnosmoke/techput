...
export default function AIPractise() {
  return (
    <section className="ai-practise">
      <div className="container flex flex-col justify-between items-center gap-5.5">
        ...
        <p className="text-3xl max-sm:text-lg text-stone-500 max-w-290 max-sm:max-w-80 text-center">
          ...
          режимами работы и даёт пояснение. Обратная связь появляется сразу
          после загрузки — это ускоряет обучение и делает прогресс измеримым.
        </p>
      </div>
    </section>
  );
